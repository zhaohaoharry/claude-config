...
> **Scope vs. neighbors.** For open-ended idea *generation* across any field, use `research-ideation`; this skill only stress-tests a near-formed idea against the AEA top-5 bar. For venue fit *outside* the AEA family, use `journal-fit`.
